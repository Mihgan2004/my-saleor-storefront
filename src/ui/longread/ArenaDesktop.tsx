...
/** ✅ заполнил массивы — без них карточки не появятся */
const photos: Photo[] = [
	{
...
function ArenaSlide({ photo, index, seg, progress }: ArenaSlideProps) {
	...
	return (
		<motion.div className="absolute inset-0" style={{ opacity: imgOpacity }}>
			...
			>
				<Image src={photo.src} alt={photo.alt} fill sizes="50vw" className="object-cover" priority />
			</motion.div>
